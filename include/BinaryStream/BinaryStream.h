...
namespace Binary
{
	...
	{
	protected:
		/// \brief A pointer to the Buffer object that represents the binary data.
		/// The Buffer object provides helper functions for working with the binary data.
		Buffer *buffer;
		/// \brief Current position in the buffer.
		size_t position;

		/// \brief Represents the current octet being used in the buffer for bit operations.
		uint8_t currentOctet;
		/// \brief Keeps track of the number of bits that have been processed so far.
		size_t bitCount;
